  ...
  <div>
    ...
    <div class="main">
      <div class="py-container">
        ...
        <!--selector-->
        <SearchSelector @getTrade="getSTrade" @getProps="getProps" />
        ...
        <div class="details clearfix">
          ...
          <!-- 分页 -->
          <Pagination :pageNum='searchParams.pageNo' :pageSize="searchParams.pageSize" :total="total" :continue="5" @getPageNum="getPageNum" />
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    getProps(attr) {
      let props = `${attr[0].attrId}:${attr[1]}:${attr[0].attrName}`;
      if (this.searchParams.props.indexOf(props) === -1) {
        this.searchParams.props.push(props);
      } else {
        if (
          this.searchParams.props.indexOf(props) ===
          this.searchParams.props.length - 1
        )
          return;
